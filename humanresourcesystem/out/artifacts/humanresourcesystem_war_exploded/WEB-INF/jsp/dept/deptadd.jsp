...
<head>
    ...
    <script>
        ...
        function save() {
            ...
            var jsondata={"deptName":name,"deptRemark":remark};
...
<form class="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="inputName" placeholder="name" name="deptName">
        </div>
    </div>
    <div class="form-group">
        <label for="inputRemark" class="col-sm-2 control-label">备注：</label>
        <div class="col-sm-10">
            <textarea class="form-control" rows="3" name="deptRemark" id="inputRemark"></textarea>
        </div>
    </div>
    <div class="form-group">
