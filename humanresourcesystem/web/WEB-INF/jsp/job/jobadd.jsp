...
<head>
    ...
    <script>
        ...
        function save() {
            ...
            var jsondata={"jobName":name,"jobRemark":remark};
...
<form class="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" id="inputName" placeholder="name" name="jobName" required="required">
        </div>
    </div>
    <div class="form-group">
        <label for="inputRemark" class="col-sm-2 control-label">备注：</label>
        <div class="col-sm-9">
            <textarea class="form-control" rows="3" name="jobRemark" id="inputRemark"></textarea>
        </div>
    </div>
    <div class="form-group">
